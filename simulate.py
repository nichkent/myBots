...
frontLegSensorsValues = numpy.zeros(1000)
...
for i in range(1000):
    ...
    # Store targetPosition Values
    backLegTargetAngles = amplitudeBackLeg * numpy.sin(frequencyBackLeg * i + phaseOffsetBackLeg)
    frontLegTargetAngles = amplitudeFrontLeg * numpy.sin(frequencyFrontLeg * i + phaseOffsetFrontLeg)
    #numpy.save("data/sinAngles.npy", sinAngles)
...
numpy.save("data/backLegTargetPosition.npy", backLegTargetAngles)
numpy.save("data/frontLegTargetPosition.npy", frontLegTargetAngles)
p.disconnect()